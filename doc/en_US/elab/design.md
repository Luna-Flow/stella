...
Use this page to explain the structural responsibilities and implementation constraints of this module. elab in Luna-Flow/stella.

## Responsibilities

- Keep the code and docs aligned around `src/elab`.
